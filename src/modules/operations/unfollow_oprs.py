...
# -----------------------------------------------------------------------------------------
def unfollow_from_following():
    try:
        target_username = input("Enter a username to unfollow their following: ")
...
unfollow_submenu = {
    ...
    "7": {"label": "Unfollow who starred your repositories", "action": unfollow_my_stargazers},
